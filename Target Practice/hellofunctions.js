...
let canvas;
let program;
let color; //this one lives in main memory
let ucolor; //store location of shader uniform
let bufferId;
let myTimer;
...
function pickDirection(oldX, oldY) {
...
function mouseDownListener(event) {
    let rect = canvas.getBoundingClientRect(); //canvas has spacing to edge of window
    let canvasY = event.clientY - rect.top; //window -> canvas coordinates
    let flippedY = canvas.clientHeight - canvasY; //openGL wants origin lower left
