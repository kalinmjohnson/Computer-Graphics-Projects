...
let vColor:GLint; // index of the vColor vertex attribute in our shader
...
function makeWaterBuffer(gl:WebGLRenderingContext , bufferId:WebGLBuffer, program, vPosition, vColor) {
    // This method is in the other file because it is a lot of code
    let waterpoints:vec4[] = ScenePoints(numOfPoints);
