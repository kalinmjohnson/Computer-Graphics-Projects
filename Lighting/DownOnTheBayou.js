...
let ambient_light; // everyone gets this amount of light automatically
let camera_position;
let theta;
let light_position;
let light_direction;
...
function makeWaterBuffer(gl, bufferId, program, vPosition, vNormal) {
    // This method is in the other file because it is a lot of code
    let waterpoints = ScenePoints(numOfPoints, originX, originY, radius, boatsidey);
...
function boatMatrix(mvOriginal) {
...
function render() {
    ...
    let rightLight = new vec4(50 / 255, 255 / 255, 50 / 255, 1.0);
    let leftLight = new vec4(255 / 255, 50 / 255, 50 / 255, 1.0);
    let hazardLight = new vec4(150 / 256, 80 / 256, 0, 1);
